<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <form name="add_cat" id="add_cat" method="POST" action="<?php echo base_url()?>admin/add_category"  enctype="multipart/form-data"/>
    ...
    <input class="form-control" type="text"  name="sub_cat_title" value="" required>
    <br/>
