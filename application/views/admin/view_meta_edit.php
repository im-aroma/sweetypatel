  ...
  <div class="content-wrapper">
    ...
    <form name="edit_meta" id="edit_meta" method="POST" action="<?php echo base_url(); ?>admin/meta_update"  enctype="multipart/form-data" />
   ...
   <?php 
    ...
    <label for='last name' id='label_title'><b>Video Title:</b></label>
    ...
    <select class="form-control" name='title_id' id='title_id'>
     ...
     <?php 
          //print_r($videos);    
          foreach($videos as $val_vid) 
          { 


     ?>

     <option value="<?php echo $val_vid['video_id']; ?>"><?php echo $val_vid['video_title']; ?></option>
