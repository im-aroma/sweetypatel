  ...
  <div class="content-wrapper">
    ...
    <a href="<?php echo base_url(); ?>admin/add_states" style="float:right;">Add States</a>
    ...
    <table id="example" class="table table-striped table-bordered" style="width:100%;padding-left:1%;">
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td><a href="<?php echo base_url(); ?>admin/edit_state/<?php echo $val['id']; ?>">Edit</a>/<a onclick="del_confirm('<?php echo $val['id']; ?>');" href="#">Delete</a></td>
 ...
 <script>
...

   {
...

       {
           ...
           window.location.href="<?php echo base_url(); ?>admin/del_state/"+val;
