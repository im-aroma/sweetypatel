  ...
  <div class="content-wrapper">
    ...
    <label for="last name"><b>Sub Video Title:</b></label>

    <input type="text" class="form-control" name="sub_vid_title" value="<?php echo $val['sub_video_title'];?>" required>
    ...
    <img src="<?php echo base_url(); ?>uploads/video_images/<?php echo $val['video_imge']; ?>" width="50" height="50" />
