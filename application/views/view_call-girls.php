    ...
    <div class="container">
       <div class="row">
          ...
          <div class="col-12">
             ...
             <div class="row">
               <?php 
               //   echo '<pre>'; print_r($get_all_prof); die; 
                   foreach($get_all_prof as $res){
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                   <div class="new-search info  no-resize img-user img-user-big bg-none" data-pid="284">
                      <figure>
                         <a href="<?php echo base_url()?>profile/<?php echo $res['title']?>/<?php echo $res['id']?>"> <img data-src="<?php echo base_url();?>uploads/profile/<?php echo $pro_post_imge[1]?>" class="img-fluid lazy loaded" alt="<?php echo $pro_alt_title[1];?>" src="<?php echo base_url();?>uploads/profile/<?php echo $pro_post_imge[1]?>" data-was-processed="true"> </a>
                      ...
                      <div class=" pt-3 position-relative">
                         <h3 class="mt-0 text-uppercase font-weight-bold"><a href="<?php echo base_url()?>profile/<?php echo $res['title']?>/<?php echo $res['id']?>"><?php echo $res['title'];?></a></h3>
                      </div>
                   </div>
                </div>
