       ...
       <div class="row">
          ...
          <div class="col-12">
             ...
             <div class="row">
               ...
               foreach($get_loc as $get_loc_val)
            ...
            ?>
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                   <div class="new-search info  no-resize img-user img-user-big bg-none" data-pid="284">
                      <figure>
                         <a href="<?php echo base_url(); ?>location/<?php echo str_replace(" ","-",trim($get_loc_val['sub_loc_title']));  ?>/<?php echo $get_loc_val['id']; ?>"> <img data-src="<?php echo base_url(); ?>uploads/location/<?php echo $get_loc_val['loc_img']; ?>" class="img-fluid lazy loaded" alt="Brittany" src="<?php echo base_url(); ?>uploads/location/<?php echo $get_loc_val['loc_img']; ?>" data-was-processed="true"> </a>
                      ...
                      <div class=" pt-3 position-relative">
                         <h3 class="mt-0 text-uppercase font-weight-bold"><a href="<?php echo base_url(); ?>location/<?php echo str_replace(" ","-",trim($get_loc_val['sub_loc_title']));  ?>/<?php echo $get_loc_val['id']; ?>"><?php echo $get_loc_val['sub_loc_title']; ?></a></h3>
                      </div>
                   </div>
                </div>
                <?php } ?>
